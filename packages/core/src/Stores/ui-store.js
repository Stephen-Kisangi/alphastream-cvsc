...
export default class UIStore extends BaseStore {
    ...
    // Alphastream: default to dark mode everywhere, matching the landing
    // page which is dark-only with no light variant. Users can still
    // toggle back to light from account settings.
