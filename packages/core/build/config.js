...
const copyConfig = base => {
    const patterns = [
        ...
        // [AI] Alphastream: ship a translations folder so the i18n loader's
        // request for /translations/<lang>.json resolves instead of 404ing.
        {
            from: path.resolve(__dirname, '../src/public/translations'),
            to: 'translations',
